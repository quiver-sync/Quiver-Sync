...
import { Instagram, Github, Mail, Waves } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-10 gap-y-12 text-sm">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-sky-700">
              QuiverSync
            </h3>
          </div>
          <p className="text-gray-600 leading-relaxed">
            Helping surfers match the perfect board to every wave, every
            session.
          </p>

          <div className="flex gap-4 mt-6 text-sky-600 justify-start sm:justify-start md:justify-start flex-wrap">
            <motion.a
              whileHover={{ scale: 1.2, y: -2 }}
              href="https://github.com/Galevi1998"
              target="_blank"
              rel="noreferrer"
      ...
      <div className="border-t border-blue-300 pt-6 pb-8 text-center text-xs text-gray-500">
        © {new Date().getFullYear()} QuiverSync — Built with 💙 for the ocean
        community 🌊
      </div>
    </motion.footer>
  );
